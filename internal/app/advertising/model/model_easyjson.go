...
func easyjsonC80ae7adDecodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel2(in *jlexer.Lexer, out *AdvertisingListItem) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC80ae7adEncodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel2(out *jwriter.Writer, in AdvertisingListItem) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
// MarshalJSON supports json.Marshaler interface
func (v AdvertisingListItem) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v AdvertisingListItem) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonC80ae7adEncodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel2(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *AdvertisingListItem) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *AdvertisingListItem) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC80ae7adDecodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel2(l, v)
}
func easyjsonC80ae7adDecodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel3(in *jlexer.Lexer, out *AdvertisingList) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "list":
			if in.IsNull() {
				...
				if out.List == nil {
					if !in.IsDelim(']') {
						out.List = make([]AdvertisingListItem, 0, 1)
					} else {
						out.List = []AdvertisingListItem{}
					}
				} else {
					out.List = (out.List)[:0]
				}
				for !in.IsDelim(']') {
					var v1 AdvertisingListItem
...
func easyjsonC80ae7adEncodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel3(out *jwriter.Writer, in AdvertisingList) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonC80ae7adDecodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel4(in *jlexer.Lexer, out *AdvertisingID) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC80ae7adEncodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel4(out *jwriter.Writer, in AdvertisingID) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonC80ae7adDecodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel5(in *jlexer.Lexer, out *AdvertisingAdd) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC80ae7adEncodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel5(out *jwriter.Writer, in AdvertisingAdd) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonC80ae7adDecodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel6(in *jlexer.Lexer, out *Advertising) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC80ae7adEncodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel6(out *jwriter.Writer, in Advertising) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Advertising) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC80ae7adEncodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel6(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Advertising) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonC80ae7adDecodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel6(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Advertising) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC80ae7adDecodeGithubComKostikansAvitoTechadvertisingInternalAppAdvertisingModel6(l, v)
}
